...
public class CountDownView extends LinearLayout{
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textCorlor=array.getColor(R.styleable.CountDownView_countTextDownColor, Color.WHITE);
        textSize=array.getDimensionPixelSize(R.styleable.CountDownView_countTextDownSize,
                DisplayUtil.sp2px(context,8));
        array.recycle();
        init();
    }
    private void init() {
        ...
        timeView.setText("");
        timeView.setTextColor(getTextCorlor());
        ...
        milLowView.setText("");
        milLowView.setTextColor(getTextCorlor());
        ...
        milview.setText("");
        milview.setTextColor(getTextCorlor());
