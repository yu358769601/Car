...
public class CountryListView extends ListView implements Runnable {
    ...
    case MotionEvent.ACTION_MOVE: 
        if (mLastDownY != 0f) { 
              ...
              if ((mDistance < 0  && getFirstVisiblePosition() == 0 && getChildAt(0)!=null && getChildAt(0).getTop() == 0) || (mDistance > 0 && getLastVisiblePosition() == getCount() - 1)) { 
                   mDistance /= 2; 
