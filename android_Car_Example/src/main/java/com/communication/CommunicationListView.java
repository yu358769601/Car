...
public class CommunicationListView extends ExpandableListView implements OnScrollListener,OnGroupClickListener {
	public CommunicationListView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		registerListener();
	}

	public CommunicationListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		registerListener();
	}

	public CommunicationListView(Context context) {
		super(context);
		registerListener();
	}
...
//	public void setAdapter(SuperTreeViewAdapter adapter) {
